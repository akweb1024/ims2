...
export const KRA_KPI_TEMPLATES: KRAKPITemplate[] = [
    ...
    // ── Journal / editorial pipeline roles ───────────────────────────────
    // Modelled on the submission→triage→peer-review→copy-edit→proof→publish
    // flow. Families split editorial (decisions) from production (copy/proof).
    {
        id: 'journal_manager',
        name: 'Journal Manager Template',
        family: 'Journal — Editorial',
        roleType: 'MANAGER',
        kra: 'Own end-to-end journal operations — keep the submission-to-publication pipeline healthy, release issues on time, hold editorial SLAs across stages, and minimise reject/withdrawal leakage.',
        kpis: [
            { title: 'Issues released on schedule', target: 100, current: 0, unit: 'PERCENT', period: 'MONTHLY', category: 'TIMELINESS' },
            { title: 'Submission-to-first-decision time', target: 21, current: 0, unit: 'DAYS_MAX', period: 'MONTHLY', category: 'SPEED' },
            { title: 'Manuscripts cleared to published', target: 40, current: 0, unit: 'MANUSCRIPTS', period: 'MONTHLY', category: 'THROUGHPUT' },
            { title: 'Editorial SLA adherence across stages', target: 95, current: 0, unit: 'PERCENT', period: 'MONTHLY', category: 'SLA' },
            { title: 'Reviewer pool growth', target: 20, current: 0, unit: 'REVIEWERS', period: 'QUARTERLY', category: 'CAPACITY' },
            { title: 'Author complaint rate', target: 3, current: 0, unit: 'PERCENT_MAX', period: 'QUARTERLY', category: 'QUALITY' },
        ],
    },
    {
        id: 'editor_in_chief',
        name: 'Editor-in-Chief Template',
        family: 'Journal — Editorial',
        roleType: 'MANAGER',
        kra: 'Safeguard scholarly quality and editorial integrity — uphold acceptance standards, drive board engagement, enforce ethics/plagiarism policy, and grow journal impact.',
        kpis: [
            { title: 'Final editorial decisions issued', target: 30, current: 0, unit: 'DECISIONS', period: 'MONTHLY', category: 'OUTPUT' },
            { title: 'Ethics / plagiarism cases resolved', target: 100, current: 0, unit: 'PERCENT', period: 'MONTHLY', category: 'INTEGRITY' },
            { title: 'Acceptance rate within policy band', target: 25, current: 0, unit: 'PERCENT', period: 'MONTHLY', category: 'STANDARDS' },
            { title: 'Editorial board active participation', target: 80, current: 0, unit: 'PERCENT', period: 'QUARTERLY', category: 'GOVERNANCE' },
            { title: 'Special issues / calls launched', target: 2, current: 0, unit: 'ISSUES', period: 'QUARTERLY', category: 'GROWTH' },
            { title: 'Average review quality rating', target: 8, current: 0, unit: 'RATING/10', period: 'QUARTERLY', category: 'QUALITY' },
        ],
    },
    {
        id: 'handling_editor_individual',
        name: 'Handling / Section Editor Template',
        family: 'Journal — Editorial',
        roleType: 'INDIVIDUAL',
        kra: 'Triage assigned manuscripts, secure qualified reviewers, and drive timely, well-reasoned editorial decisions with minimal stalls.',
        kpis: [
            { title: 'Manuscripts triaged within SLA', target: 95, current: 0, unit: 'PERCENT', period: 'MONTHLY', category: 'TIMELINESS' },
            { title: 'Reviewer assignment turnaround', target: 48, current: 0, unit: 'HOURS_MAX', period: 'WEEKLY', category: 'SPEED' },
            { title: 'Decisions rendered', target: 20, current: 0, unit: 'DECISIONS', period: 'MONTHLY', category: 'OUTPUT' },
            { title: 'Stalled manuscripts over 30 days', target: 5, current: 0, unit: 'PERCENT_MAX', period: 'MONTHLY', category: 'QUALITY' },
            { title: 'Reviewer invite acceptance rate', target: 60, current: 0, unit: 'PERCENT', period: 'MONTHLY', category: 'CAPACITY' },
            { title: 'Desk-reject accuracy (not overturned)', target: 90, current: 0, unit: 'PERCENT', period: 'QUARTERLY', category: 'QUALITY' },
        ],
    },
    {
        id: 'peer_review_coordinator_individual',
        name: 'Peer-Review Coordinator Template',
        family: 'Journal — Editorial',
        roleType: 'INDIVIDUAL',
        kra: 'Keep the peer-review engine moving — recruit reviewers, chase timely reviews, and maximise completed, high-quality reviews per manuscript.',
        kpis: [
            { title: 'Reviews completed on time', target: 90, current: 0, unit: 'PERCENT', period: 'MONTHLY', category: 'TIMELINESS' },
            { title: 'Average review turnaround', target: 14, current: 0, unit: 'DAYS_MAX', period: 'MONTHLY', category: 'SPEED' },
            { title: 'Reviewers recruited / onboarded', target: 15, current: 0, unit: 'REVIEWERS', period: 'MONTHLY', category: 'CAPACITY' },
            { title: 'Manuscripts with 2+ completed reviews', target: 95, current: 0, unit: 'PERCENT', period: 'MONTHLY', category: 'COVERAGE' },
            { title: 'Reviewer reminder follow-ups logged', target: 60, current: 0, unit: 'FOLLOWUPS', period: 'MONTHLY', category: 'ACTIVITY' },
            { title: 'Review usefulness rating', target: 8, current: 0, unit: 'RATING/10', period: 'QUARTERLY', category: 'QUALITY' },
        ],
    },
    {
        id: 'copy_editor_individual',
        name: 'Copy Editor Template',
        family: 'Journal — Production',
        roleType: 'INDIVIDUAL',
        kra: 'Deliver clean, style-compliant copy-edited manuscripts on time with minimal rework and consistent house-style adherence.',
        kpis: [
            { title: 'Daily copy-editing tasks completed', target: 6, current: 0, unit: 'TASKS', period: 'DAILY', category: 'OUTPUT' },
            { title: 'Manuscripts copy-edited', target: 30, current: 0, unit: 'MANUSCRIPTS', period: 'MONTHLY', category: 'THROUGHPUT' },
            { title: 'Copy-editing turnaround per paper', target: 3, current: 0, unit: 'DAYS_MAX', period: 'WEEKLY', category: 'SPEED' },
            { title: 'House-style compliance score', target: 95, current: 0, unit: 'PERCENT', period: 'MONTHLY', category: 'QUALITY' },
            { title: 'Rework / returned-by-author rate', target: 5, current: 0, unit: 'PERCENT_MAX', period: 'MONTHLY', category: 'QUALITY' },
            { title: 'Reference / citation accuracy', target: 98, current: 0, unit: 'PERCENT', period: 'MONTHLY', category: 'ACCURACY' },
        ],
    },
    {
        id: 'proofreader_galley_individual',
        name: 'Proofreader / Galley Template',
        family: 'Journal — Production',
        roleType: 'INDIVIDUAL',
        kra: 'Guarantee error-free galleys/proofs before publication with a high defect-catch rate and fast proof turnaround.',
        kpis: [
            { title: 'Daily proofreading tasks completed', target: 8, current: 0, unit: 'TASKS', period: 'DAILY', category: 'OUTPUT' },
            { title: 'Galleys / proofs cleared', target: 35, current: 0, unit: 'PROOFS', period: 'MONTHLY', category: 'THROUGHPUT' },
            { title: 'Proof turnaround per article', target: 24, current: 0, unit: 'HOURS_MAX', period: 'WEEKLY', category: 'SPEED' },
            { title: 'Error / defect catch rate', target: 98, current: 0, unit: 'PERCENT', period: 'MONTHLY', category: 'QUALITY' },
            { title: 'Post-publication errata attributable', target: 1, current: 0, unit: 'MAX', period: 'MONTHLY', category: 'QUALITY' },
            { title: 'On-time proof delivery for issue close', target: 100, current: 0, unit: 'PERCENT', period: 'MONTHLY', category: 'TIMELINESS' },
        ],
    },
    {
        id: 'plagiarism_quality_checker_individual',
        name: 'Plagiarism / Quality Checker Template',
        family: 'Journal — Production',
        roleType: 'INDIVIDUAL',
        kra: 'Screen every submission for originality and technical compliance, catching integrity issues before peer review with fast, accurate checks.',
        kpis: [
            { title: 'Daily screening tasks completed', target: 10, current: 0, unit: 'TASKS', period: 'DAILY', category: 'OUTPUT' },
            { title: 'Submissions screened', target: 50, current: 0, unit: 'MANUSCRIPTS', period: 'MONTHLY', category: 'THROUGHPUT' },
            { title: 'Similarity checks within SLA', target: 98, current: 0, unit: 'PERCENT', period: 'MONTHLY', category: 'TIMELINESS' },
            { title: 'Screening turnaround per manuscript', target: 24, current: 0, unit: 'HOURS_MAX', period: 'WEEKLY', category: 'SPEED' },
            { title: 'Missed-issue leakage caught later', target: 2, current: 0, unit: 'PERCENT_MAX', period: 'MONTHLY', category: 'QUALITY' },
            { title: 'Compliance checklist completion', target: 100, current: 0, unit: 'PERCENT', period: 'MONTHLY', category: 'COMPLIANCE' },
        ],
    },
    {
