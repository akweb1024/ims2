        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            {isLoading ? (
                ...
                <div className="space-y-3">
                    {tickets.map((t: any) => (
                        <Link key={t.id} href={`/dashboard/support/${t.id}`} className="card-premium p-5 flex items-center justify-between gap-4 hover:-translate-y-0.5 hover:shadow-lg transition-all group">
