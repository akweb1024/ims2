...
export default function NewProjectPage() {
  ...
  const validateForm = () => {
    ...
    if (formData.isRevenueBased && formData.estimatedRevenue <= 0)
      newErrors.estimatedRevenue = "Revenue target must be positive";
    setErrors(newErrors);
              ...
              >
                ...
                <div className="space-y-8">
                  <div className="space-y-2">
                    ...
                    />
                    {errors.name && (
                      <p className="text-[10px] font-black text-rose-500 uppercase tracking-widest ml-4">
                        {errors.name}
                      </p>
                    )}
                  </div>
                        ...
                        >
                          <div className="flex items-center gap-6 mb-6">
                            ...
                            <button
                              ...
                              onClick={() =>
                                setMilestones(
                                  milestones.filter((ms) => ms.id !== m.id),
                                )
                              }
                          ...
                          <textarea
                            ...
                            placeholder="Marker Intel..."
                            rows={2}
                            className="w-full bg-white border border-slate-100 rounded-xl px-6 py-4 text-xs text-slate-500 outline-none resize-none"
                          />
                        </motion.div>
                      ))
                    )}
            ...
            <div className="space-y-8">
              ...
              >
                <h3 className="text-[10px] font-black text-white/40 uppercase tracking-widest mb-8 flex items-center gap-3">
                  <Shield className="h-4 w-4 text-indigo-300" /> Visibility
                  Matrix
                </h3>
                <div className="space-y-6">
                  <select
                  ...
                  >
                    <option value="PRIVATE" className="bg-indigo-700">
                      Company Only (Private)
                    </option>
                    <option value="PUBLIC" className="bg-indigo-700">
                      Public Protocol
                    </option>
                    <option value="INDIVIDUALS" className="bg-indigo-700">
                      Specific Agents
                    </option>
                  </select>
                    ...
                    <div className="space-y-4 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
                      {users.map((u) => (
                        ...
                        >
                          <input
                            type="checkbox"
                            checked={formData.sharedWithIds.includes(u.id)}
                            onChange={(e) => {
                              const newIds = e.target.checked
                                ? [...formData.sharedWithIds, u.id]
                                : formData.sharedWithIds.filter(
                                    (id) => id !== u.id,
                                  );
                              setFormData({
                                ...formData,
              ...
              >
                <h3 className="text-[10px] font-black text-white/40 uppercase tracking-widest mb-8 flex items-center gap-3">
                  <DollarSign className="h-4 w-4 text-emerald-300" /> Fiscal
                  Yield
                </h3>
                <div className="space-y-8">
                  <div className="space-y-2">
                  ...
                  <div className="pt-6 border-t border-white/10 flex flex-col items-center">
                    ...
                    <p className="text-3xl font-black text-white">
                      ₹
                      {(
                        (formData.estimatedRevenue * formData.itDepartmentCut) /
                        100
                      ).toLocaleString()}
                    </p>
                  </div>
              ...
              >
                <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-10 flex items-center gap-3">
                  <Globe className="h-4 w-4 text-blue-600" /> Linked
                  Infrastructure
                </h3>
                <div className="space-y-4">
                  ...
                  <p className="text-[9px] font-medium text-slate-400 italic px-2 leading-relaxed">
                    Sync project status with live website uptime and performance
                    metrics.
                  </p>
                </div>
              </motion.div>
