    ...
    return (
        <DashboardLayout userRole={userRole}>
            <CRMPageShell
                ...
                breadcrumb={[{ label: 'CRM', href: '/dashboard/crm' }, { label: 'Subscriptions' }]}
                ...
                actions={
                    <div className="flex items-center gap-3">
                        ...
                        <div className="bg-secondary-50 text-secondary-700 px-6 py-3 rounded-2xl border border-secondary-200 text-[10px] font-black uppercase tracking-[0.2em] shadow-sm">
                            Auto-generated from paid invoices
                        </div>
                    </div>
                }
            >
                <div className="mb-8 bg-white border border-secondary-100 rounded-2xl p-6 flex flex-col sm:flex-row sm:items-center gap-4 shadow-sm">
                    <div className="w-10 h-10 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center font-black">
                        ✓
                    </div>
                    <div className="flex-1">
                        <p className="text-sm font-black text-secondary-900">Subscriptions are created automatically after invoice payment.</p>
                        <p className="text-xs text-secondary-500 font-medium">To create a subscription, generate an invoice and confirm payment.</p>
                    </div>
                    <Link
                        href="/dashboard/crm/invoices"
                        className="btn btn-secondary px-5 py-2 text-[10px] font-black uppercase tracking-widest"
                    >
                        Go to Invoices
                    </Link>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <CRMStatCard
                        ...
                        trend={{ value: 'Records', label: 'tracked', isPositive: true }}
                    />
                </div>
