                        ...
                        <div key={stage.id} className={`flex-1 rounded-xl border flex flex-col ${stage.color}`}>
                            ...
                            <div className="p-3 flex-1 overflow-y-auto space-y-3">
                                {deals.filter(d => d.stage === stage.id).map(deal => (
                                    <div key={deal.id} className="bg-white p-3 rounded-lg shadow-sm border border-secondary-100 hover:shadow-md transition-shadow cursor-pointer">
                                        <div className="font-semibold text-secondary-900 mb-1 leading-tight">{deal.title}</div>
