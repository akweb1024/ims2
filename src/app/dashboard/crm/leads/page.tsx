...
import { 
    UserPlus, Search, Filter, Plus, Eye, 
    TrendingUp, UserCheck, Globe, Mail, Phone,
    Building2, Activity, MoreHorizontal, Target,
    ShieldCheck, Zap, Sparkles, Layers, ChevronRight,
    Clock, Archive
} from 'lucide-react';
...
export default function LeadsPage() {
    ...
    const [newLead, setNewLead] = useState({
        name: '', primaryEmail: '', organizationName: '', primaryPhone: '',
        status: 'NEW', source: 'DIRECT', notes: ''
    });
    ...
    return (
        <CRMClientLayout>
            <CRMPageShell
                ...
                breadcrumb={[{ label: 'CRM', href: '/dashboard/crm' }, { label: 'Leads Matrix' }]}
                actions={
                    <div className="flex items-center gap-3">
                         <div className="hidden lg:flex items-center gap-3 bg-secondary-950 px-4 py-2 rounded-2xl border border-white/5 shadow-inner">
                             <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-[9px] font-black uppercase tracking-widest text-primary-400">Lead Stream</span>
                             </div>
                         </div>
                         <button
            ...
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <CRMStatCard
                        ...
                        trend={{ value: 'In-flow', label: 'Telemetry active', isPositive: true }}
                    />
                    <CRMStatCard
                         ...
                         <CRMTable>
                             <thead>
                                 <tr className="bg-secondary-50/50 border-b border-secondary-100">
                                     <th className="px-8 py-5 text-[10px] font-black uppercase tracking-widest text-secondary-400 italic">Lead Identity</th>
                                     <th className="px-6 py-5 text-[10px] font-black uppercase tracking-widest text-secondary-400 italic text-center">Protocol Phase</th>
                                     <th className="px-6 py-5 text-[10px] font-black uppercase tracking-widest text-secondary-400 italic text-center">Threat Score</th>
                                     <th className="px-6 py-5 text-[10px] font-black uppercase tracking-widest text-secondary-400 italic">Signal Source</th>
                                     <th className="px-6 py-5 text-[10px] font-black uppercase tracking-widest text-secondary-400 italic">Node Custodian</th>
                             ...
                             <tbody className="divide-y divide-secondary-50">
                                 {loading ? (
                                     ...
                                     leads.map((lead) => (
                                         <tr key={lead.id} className="group hover:bg-secondary-50/50 transition-all duration-500">
                                                 ...
                                                 <div className="flex flex-col">
                                                     ...
                                                     <div className="flex items-center gap-3 pl-3.5">
                                                          <span className="text-[9px] font-black text-secondary-300 uppercase tracking-widest truncate max-w-[140px] lowercase flex items-center gap-1">
                                                               <Mail size={10} className="text-secondary-200" /> {lead.primaryEmail}
                                                          </span>
                                                          {lead.organizationName && (
                                                              <>
                                                                  ...
                                                                  <span className="text-[9px] font-black text-secondary-300 uppercase tracking-widest truncate max-w-[120px] flex items-center gap-1">
                                                                       <Building2 size={10} className="text-secondary-200" /> {lead.organizationName}
                                                                  </span>
                                                              </>
                                                          )}
                                                     </div>
                                             ...
                                             <td className="px-6 py-6 text-center">
                                                 <CRMBadge variant={getStatusVariant(lead.leadStatus)} className="px-4 py-1.5 rounded-full text-[9px] font-black border-none uppercase tracking-[0.2em] italic shadow-sm" dot>
                                             ...
                                             <td className="px-6 py-6 text-center">
                                                 <div className="inline-flex items-center gap-2 bg-secondary-950 text-white px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-secondary-950/20 group-hover:bg-primary-600 transition-colors">
                                                     <Activity size={10} className="text-primary-400 group-hover:text-white" />
                                                     {lead.leadScore}
                                                 </div>
                                             </td>
                                             ...
                                             <td className="px-6 py-6">
                                                 {lead.assignedTo ? (
                                                     <div className="flex items-center gap-3">
                                                         ...
                                                         <div className="flex flex-col">
                                                             <span className="text-[11px] font-black text-secondary-950 uppercase tracking-tight italic">{lead.assignedTo.name}</span>
                                                             <span className="text-[8px] font-black text-secondary-300 uppercase tracking-[0.3em] mt-0.5">CUSTODIAN</span>
                                                         </div>
                                                     </div>
                                                 ) : (
                                                     <CRMBadge variant="secondary" className="px-3 py-1 text-[8px] font-black border-none uppercase tracking-[0.2em]">ORPHAN_NODE</CRMBadge>
                                                 )}
                                             </td>
                ...
                >
                    <form onSubmit={handleCreateLead} className="space-y-8 py-2">
                        <div className="bg-secondary-950 p-8 rounded-[2.5rem] border border-white/5 shadow-2xl relative overflow-hidden">
                             ...
                             <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                                  <div className="space-y-2">
                                       <label className="text-[10px] font-black uppercase tracking-[0.3em] text-primary-400 pl-1">Target Designation</label>
                                       <input
                                           type="text" required
                                  ...
                                  <div className="space-y-2">
                                       <label className="text-[10px] font-black uppercase tracking-[0.3em] text-primary-400 pl-1">Communication Channel (Email)</label>
                                       <input
                                           type="email" required
                        ...
                        <div className="space-y-2 px-2">
                            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-secondary-400 pl-1">Organization / Institution Matrix</label>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-2">
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-secondary-400 pl-1">Initial Phase</label>
                                <select
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-secondary-400 pl-1">Capture Source</label>
                                <select
                                    className="input h-14 bg-secondary-50 border-secondary-100 font-black text-xs uppercase tracking-widest italic pr-10"
                        ...
                        <div className="space-y-2 px-2">
                            <label className="text-[10px] font-black uppercase tracking-[0.2em] text-secondary-400 pl-1">Intelligence Context (Metadata)</label>
                            <textarea
                        ...
                        <div className="flex gap-4 pt-10 border-t border-secondary-100/50">
                            ...
                            >
                                {createLoading ? 'Synchronizing...' : (
                                    <>
                                        Establish Signal Node <ChevronRight size={16} className="group-hover/btn:translate-x-1 transition-transform" />
                                    </>
                                )}
                            </button>
                        </div>
