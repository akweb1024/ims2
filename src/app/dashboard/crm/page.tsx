    ...
    return (
        <CRMClientLayout>
            <CRMPageShell
                ...
                subtitle="Orchestrate high-fidelity customer relations, monitor global revenue trajectories, and respond to tactical operational alerts."
                icon={<LayoutDashboard className="w-5 h-5" />}
                breadcrumb={[{ label: 'CRM', href: '/dashboard/crm' }, { label: 'Intelligence Matrix' }]}
                actions={
                    <div className="flex items-center gap-3">
                         <div className="hidden lg:flex items-center gap-3 bg-secondary-950 px-4 py-2 rounded-2xl border border-white/5 shadow-inner">
                             <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-[9px] font-black uppercase tracking-widest text-emerald-400">Live Telemetry</span>
                             </div>
                             <div className="h-4 w-px bg-white/10" />
                             <span className="text-[9px] font-black uppercase tracking-widest text-secondary-400 opacity-60">Status: Nominal</span>
                         </div>
                         <button className="bg-primary-600 text-white px-8 py-3.5 rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] shadow-2xl shadow-primary-200 hover:bg-primary-700 transition-all flex items-center gap-3 active:scale-95 group">
                        ...
                        <div className="lg:col-span-8 space-y-10">
                            <div className="bg-secondary-950 p-8 md:p-12 rounded-[4rem] border border-white/5 shadow-2xl relative overflow-hidden group">
                                ...
                                <div className="flex flex-col sm:flex-row items-center justify-between mb-12 relative z-10 gap-6">
                                    <div className="flex items-center gap-6">
                                         ...
                                         <div>
                                              <h3 className="text-xl font-black text-white uppercase tracking-tight italic leading-tight">Growth Projection Vector</h3>
                                              <p className="text-[10px] font-black text-primary-400 uppercase tracking-[0.4em] mt-2">Customer Acquisition Matrix (6-Month Delta)</p>
                                         </div>
                                    </div>
                                    <div className="flex bg-white/5 p-1.5 rounded-2xl border border-white/10 backdrop-blur-md">
                                         <button className="px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-wider bg-primary-600 text-white shadow-2xl shadow-primary-900 transition-all">Propulsion</button>
                                         <button className="px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-wider text-white/40 hover:text-white transition-all uppercase italic">Archives</button>
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                 <div className="bg-white p-8 rounded-[3rem] border border-secondary-100 shadow-xl shadow-secondary-100/50 flex items-center gap-6 group hover:translate-y-[-4px] transition-all">
                                      ...
                                      <div>
                                           <p className="text-[9px] font-black text-emerald-700/60 uppercase tracking-widest pl-0.5 mb-1.5">Compliance Level</p>
                                           <h4 className="text-lg font-black text-secondary-950 uppercase tracking-tight italic">98.4% Nominal</h4>
                                      </div>
                                 </div>
                                 <div className="bg-white p-8 rounded-[3rem] border border-secondary-100 shadow-xl shadow-secondary-100/50 flex items-center gap-6 group hover:translate-y-[-4px] transition-all">
                                      ...
                                      <div>
                                           <p className="text-[9px] font-black text-indigo-700/60 uppercase tracking-widest pl-0.5 mb-1.5">Node Connectivity</p>
                                           <h4 className="text-lg font-black text-secondary-950 uppercase tracking-tight italic">Global Sync active</h4>
                                      </div>
                                 </div>
                            </div>
                        </div>
                            ...
                            <div className="bg-white p-8 md:p-10 rounded-[4rem] border border-secondary-100 shadow-2xl shadow-secondary-100/50 overflow-hidden relative group">
                                ...
                                <div className="flex items-center gap-5 mb-10 relative z-10 border-b border-secondary-100 pb-8">
                                    ...
                                    <div className="flex flex-col">
                                         <h3 className="text-xl font-black text-secondary-950 uppercase tracking-tight italic leading-tight">Identity Stream</h3>
                                         <p className="text-[9px] font-black text-secondary-400 uppercase tracking-[0.4em] mt-2 italic leading-tight">Live telemetry & interaction logs.</p>
                                    </div>
                                </div>
