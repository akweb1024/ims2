...
export default function ConferenceDetailPage() {
    ...
    const [activeTab, setActiveTab] = useState<'overview' | 'tickets' | 'tracks' | 'sponsors'>('overview');
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm text-secondary-600">
                                {conference.status === 'DRAFT' && 'This conference is not yet published. Add tickets and publish when ready.'}
