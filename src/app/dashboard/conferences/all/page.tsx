...
import { Calendar, MapPin, Users, Plus, Search, Eye, Trash2, CheckCircle, Clock, X, Brain, AlertCircle } from 'lucide-react';
        ...
        <DashboardLayout userRole={userRole}>
            <div className="space-y-6">
                <div className="flex items-start justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-black text-secondary-900">All Conferences</h1>
                        <p className="text-secondary-500 mt-1">A dedicated list view for every conference, without follow-up matrix noise.</p>
                    </div>
                    {canCreate && (
                        <button
                ...
                {loading ? (
                    <div className="card-premium p-12 text-center text-secondary-500">Loading conferences...</div>
