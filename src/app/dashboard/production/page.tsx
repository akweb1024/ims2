...
export default function ProductionPage() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const [journalsRes, articlesRes] = await Promise.all([
                ...
                fetch('/api/editorial/articles', { headers: { 'Authorization': `Bearer ${token}` } })
            ]);
    ...
    const apcTypes = ['OPEN_ACCESS', 'RAPID', 'WOS', 'OTHER'];

    if (loading) return <div className="p-8 text-center">Loading Production Hub...</div>;
