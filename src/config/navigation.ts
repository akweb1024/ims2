        ...
        categories: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { name: 'Grade Mapping', icon: '🗂️', href: '/dashboard/hr-management/grade-mapping', roles: ['SUPER_ADMIN', 'ADMIN', 'HR_MANAGER'] },
        ...
        categories: [
            {
                ...
                items: [
                    ...
                    { name: 'Invoices', href: '/dashboard/lms/invoice', icon: '🧾', roles: ['SUPER_ADMIN', 'ADMIN', 'MANAGER', 'HR_MANAGER'] },
        ...
        categories: [
            {
                ...
                items: [
                    ...
                    { name: 'Performance Observatory', href: '/dashboard/performance-observability', icon: '🧭', roles: ['SUPER_ADMIN', 'ADMIN', 'MANAGER', 'HR_MANAGER', 'FINANCE_ADMIN'] },
