                    ...
                    <div key={module.id} className="card-premium p-6 group hover:border-primary-200 transition-all flex flex-col justify-between">
                        <div>
                            <div className="flex justify-between items-start mb-4">
                                <div className={`p-3 rounded-2xl ${module.type === 'COMPANY' ? 'bg-indigo-50 text-indigo-600' : module.type === 'GLOBAL' ? 'bg-indigo-50 text-indigo-600' : module.type === 'DEPARTMENT' ? 'bg-orange-50 text-orange-600' : 'bg-success-50 text-success-600'}`}>
                                    <BookOpen size={20} />
                                </div>
