...
| **3. Performance Index** | Compute service + weights config + cron snapshots; employee "My Performance" + team view | Sabka index dikhe | ⬜ Next |
| **4. Focus UX** | "My KRA" widget, report form reorg around assigned metrics, off-KRA separation | Clear focus enforcement | ⬜ |
